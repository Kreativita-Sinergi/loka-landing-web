...
export const onsiteServiceDetails = {
  ...
  requirementMessage:
    "Layanan datang ke lokasi ini gratis untuk pelanggan yang mengambil paket tahunan — Lite Rp 399.000/tahun atau Pro Rp 890.000/tahun. Anda tetap bisa mencoba gratis 3 bulan lebih dulu, lalu minta dijadwalkan kunjungan setelah memutuskan berlangganan tahunan.",
  requirementPoints: [
