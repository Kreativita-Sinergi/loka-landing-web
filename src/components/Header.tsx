                  ...
                  <MenuItem>
                    ...
                    >
                      ...
                      <span>
                        ...
                        <span className="block text-xs text-gray-500 dark:text-gray-400">HP &amp; tablet · Google Play</span>
                      </span>
                    </a>
                  </MenuItem>
                  <MenuItem>
                    ...
                    >
                      ...
                      <span>
                        ...
                        <span className="block text-xs text-gray-500 dark:text-gray-400">PC &amp; laptop · Store atau file</span>
                      </span>
                    </Link>
                  </MenuItem>
                </MenuItems>
        ...
        <div id="mobile-menu" className="md:hidden bg-white shadow-lg dark:bg-background dark:border-t dark:border-surface-border">
          <ul className="flex flex-col space-y-4 pt-1 pb-6 px-6">
            ...
            <li>
              ...
              >
                <FaWindows size={14} aria-hidden="true" /> Download versi Windows
              </Link>
            </li>
          </ul>
        </div>
